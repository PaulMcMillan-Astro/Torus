		    ...
		    const int NMIN, int& integ, const int INTOL, const int err)
{
   ...
   // PSPD   jt=Jt>>GF, QP;
    PSPT   jt3=Jt3>>GF, QP3;
    double dt,dt1,dt2,dt3,time=0.,t1=Jt3(3),t3=Jt3(5),t3new,Lperp,u,
		    dT=Pi/double(Nr);
    ...
    const int     err)	    // input:	error output?
{
  ...
  int    Ni1 = Ni/10,          // max. No of iteration in 1. fit
