...
////////////////////////////////////////////////////////////////////////////////
NoTra::NoTra(const NoTra& P)
{ 
 derivs_ok=false; 
}

////////////////////////////////////////////////////////////////////////////////
PSPD NoTra::Forward(const PSPD& w) const
{
    derivs_ok=true; 
// extract w=(q,p)
    r  = w(0);
    ...
    //cerr << pz << " " << st<< " " << pr << " " <<  ct << " " << ir << " " << pt<< "\n";

    return PSPD(R,z,pR,pz);		
}
////////////////////////////////////////////////////////////////////////////////
PSPT NoTra::Forward3D(const PSPT& w3) const
{
  PSPT W3 = w3;
...
////////////////////////////////////////////////////////////////////////////////
PSPD NoTra::Backward(const PSPD& W) const
{
    derivs_ok=true; 
...
////////////////////////////////////////////////////////////////////////////////
PSPT NoTra::Backward3D(const PSPT& W3) const
{
  PSPT w3 = W3;
  PSPD W2 = W3.Give_PSPD();
...
////////////////////////////////////////////////////////////////////////////////
void NoTra::Derivatives(double dWdw[4][4]) const
{
    if(!derivs_ok)
	TorusError(" NoTra::Derivatives() called without (For/Back)ward",-3);
