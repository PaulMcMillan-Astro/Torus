...
#ifndef LogPot_def_
#define LogPot_def_ 1

#include <iostream>
#include <cmath>
#include "Potential.h"

class LogPot : public Potential {
public:
  double q, qi, q2i, v0, v0sq, v0sqhalf, rc, rc2, plusconst, Rmax;
    double Rei, Rei3;
    void   error(const char*) const;
    //public:
    LogPot(const double=1., const double=1., const double=1., const double=0.);
...
friend ostream& operator<< (ostream&, const LogPot&);
};

inline LogPot::LogPot(const double V0, const double Q,
